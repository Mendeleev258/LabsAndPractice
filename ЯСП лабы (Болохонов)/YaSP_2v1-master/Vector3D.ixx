...
public:
	...
	friend double dot(const vector3D& a, const vector3D& b); // scalar mult
...
vector3D::vector3D(std::istream& file)
{
	file >> x >> y >> z;
}
...
export double dot(const vector3D& a, const vector3D& b)
{
